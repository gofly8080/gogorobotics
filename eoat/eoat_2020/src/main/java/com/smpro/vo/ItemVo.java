...
public class ItemVo extends PagingVo {
	...
	public void setNameMaker(String nameMaker){ this.nameMaker = nameMaker.trim();}
	public String getNameMaker(){return this.nameMaker.trim();}
	...
	public String getItemSearchValue() {
		return itemSearchValue.trim();
	}

	public void setItemSearchValue(String itemSearchValue) {
		this.itemSearchValue = itemSearchValue.trim();
	}
