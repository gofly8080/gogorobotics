...
<div id="quick">
    ...
    <ul class="menus">
        ...
        <li class="cs"><a href="/shop/cscenter/list/notice">고객센터<em>${cmm_cs}</em></a></li>
        <c:if test="${tax_cs ne ''}">
            <li class="cs"><a href="/shop/cscenter/list/notice">세금계산서담당<em>${tax_cs}</em></a></li>
        </c:if>
        <li class="cs"><a href="/shop/cscenter/fax">FAX 주문하기<em>${fax}</em></a></li>
        <li class="cs"><a href="#">무통장입금 계좌<em>${bank_name}</em><em>${bank_acount}</em><em>${bank_own}</em><em>${bank_comp}</em></a></li>
    </ul>
</div>