    ...
    <div id="container">
        <div class="layout_inner sub_container">
            ...
            <div id="contents">
                ...
                <div class="sub_cont">
                    <div class="tit_box">
                        <p>${mallname}에서 취급되는 모든 개인정보는 개인정보 보호법 및 관련 법령상의 개인정보보호 규정을 준수하고 있습니다.</p>
                    </div>
                    ...
                    <div class="terms_cont">
                        ...
                        <div class="scroll_box h176">
                            <dl>
                                <dt>제22조(개인정보의 수집ㆍ이용 동의 등)</dt>
                                <dd>① 정보통신서비스 제공자는 이용자의 개인정보를 이용하려고 수집하는 경우에는 다음 각 호의 모든 사항을 이용자에게 알리고 동의를 받아야 한다. 다음 각 호의 어느 하나의 사항을 변경하려는 경우에도 또한 같다.
                                    <ol>
                                        <li>1. 개인정보의 수집·이용 목적</li>
                                ...
                                <dd>② 정보통신서비스 제공자는 다음 각 호의 어느 하나에 해당하는 경우에는 제1항에 따른 동의 없이 이용자의 개인정보를 수집·이용할 수 있다.
                                    <ol>
