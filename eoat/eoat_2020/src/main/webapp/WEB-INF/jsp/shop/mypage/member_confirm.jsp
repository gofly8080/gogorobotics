        ...
        <div class="layout_inner sub_container">
            ...
            <div id="contents">
                ...
                <div class="sub_cont myinfo">
                    <form method="post" onsubmit="return submitProc(this);" action="/shop/mypage/confirm/proc?member=mod" target="zeroframe">
                        <div class="cont_box">
                            <div class="member_pw">
                                <p class="bul_dot_gray">개인정보 조회를 위해 <em class="txt_point">비밀번호</em>를 입력해주세요.</p>
                                <div class="pw">
