							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<div class="input-group">
										<input class="form-control" type="text" id="bizNo1" name="bizNo1" value="${fn:substring(gvo.bizNo,0,3)}" maxlength="4" onblur="numberCheck(this);"/>
										<div class="input-group-addon" style="border:0">-</div>
										<input class="form-control" type="text" id="bizNo2" name="bizNo2" value="${fn:substring(gvo.bizNo,3,5)}" maxlength="2" onblur="numberCheck(this);"/>
										<div class="input-group-addon" style="border:0">-</div>
										<input class="form-control" type="text" id="bizNo3" name="bizNo3" value="${fn:substring(gvo.bizNo,5,10)}" maxlength="6" onblur="numberCheck(this);"/>
									</div>
								</div>
					...
					<form id="validation-form" method="post" action="/admin/member/mod" target="zeroframe" class="form-horizontal">
						...
						<div id="normalBox" class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-md-3">
									<input class="form-control" type="text" id="name" name="name" value="${vo.name}" maxlength="15"/>
								</div>
