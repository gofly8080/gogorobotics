...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="/admin/index" class="logo"> <!-- mini logo for sidebar mini 50x50 pixels -->
			<%--<span class="logo-mini">${mallname}</span> <!-- logo for regular state and mobile devices -->--%>
			<%--<span class="logo-lg"><b>${mallname}</b>--%>
			<span class="logo-mini">${mallname}</span> <!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>${mallname}</b>
				...
				<li class="${navi eq 'member' ? 'active':''} treeview">
					...
					<ul class="treeview-menu">
						...
						<c:if test="${sessionScope.loginType eq 'A'}">
							...
							<li ${naviSub eq '/member/grade' ? "class='active'":""}><a href="/admin/member/grade"><i class="fa fa-caret-right"></i>회원등급관리</a></li>
